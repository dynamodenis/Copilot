import { _ as p, g as j, s as q, a as H, b as K, t as Q, q as Z, l as F, c as J, F as X, K as Y, Q as ee, e as te, z as ae, H as re } from "./mermaid.core-GX_tk5Uy.js";
import { p as ne } from "./chunk-4BX2VUAB-CRQW2c7r.js";
import { p as ie } from "./mermaid-parser.core-DqBmDVMR.js";
import { d as I } from "./arc-BKS5Cfg8.js";
import { b as S, t as z, r as se, u as le } from "./main-Cdb_NCuJ.js";
function oe(e, a) {
...
function ue() {
  ...
  function l(t) {
    var n, c = (t = se(t)).length, d, y, m = 0, u = new Array(c), i = new Array(c), v = +x.apply(this, arguments), w = Math.min(z, Math.max(-z, s.apply(this, arguments) - v)), h, C = Math.min(Math.abs(w) / c, o.apply(this, arguments)), $ = C * (w < 0 ? -1 : 1), g;
    for (n = 0; n < c; ++n)
