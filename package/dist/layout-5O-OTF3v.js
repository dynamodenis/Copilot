import { b as Ve, G as g, i as m, v as E } from "./graph-C5OOnUZD.js";
import { c as C, k as Ge, m as Ye, n as he, o as ve, p as $e, q as pe, t as De, u as we, v as qe, b as We, l as f, j as R, r as j } from "./_baseUniq-DgROQpJ4.js";
import { f as O, b as be, a as ze, c as Xe, m as w, d as P } from "./min-Cqi7jgq2.js";
import { aY as He, aZ as Ue, aF as me, a_ as M, as as ge, aR as Ze, al as Je, aW as Ke, a$ as Qe, am as ye, aV as en, aE as xe, ax as nn, aH as rn, b0 as W } from "./mermaid.core-D3xORQza.js";
import { a1 as tn, _ as ee, y as ne, v as V, x as Ee, a2 as X } from "./main-Cl7J0_dP.js";
var re = 1 / 0, an = 17976931348623157e292;
function T(e) {
  if (!e)
    return e === 0 ? e : 0;
  if (e = tn(e), e === re || e === -re) {
...
function un(e) {
  return He(Ue(e, void 0, O), e + "");
}
var dn = 1, sn = 4;
function fn(e) {
  return Ve(e, dn | sn);
}
var ke = Object.prototype, cn = ke.hasOwnProperty, ln = me(function(e, n) {
  e = Object(e);
  var r = -1, t = n.length, a = t > 2 ? n[2] : void 0;
  for (a && M(n[0], n[1], a) && (t = 1); ++r < t; )
    for (var o = n[r], i = ge(o), u = -1, d = i.length; ++u < d; ) {
      var s = i[u], c = e[s];
      (c === void 0 || Ze(c, ke[s]) && !cn.call(e, s)) && (e[s] = o[s]);
    }
  return e;
});
function F(e) {
...
function pn(e, n, r) {
  ...
  if (!t)
    return -1;
  var a = r == null ? 0 : on(r);
  return a < 0 && (a = vn(t + a, 0)), Ye(e, C(n), a);
}
var H = hn(pn);
function wn(e, n) {
  return e == null ? e : Ke(e, he(n), ge);
}
function bn(e, n) {
  return e && ve(e, he(n));
}
...
var gn = Object.prototype, yn = gn.hasOwnProperty;
function xn(e, n) {
  return e != null && yn.call(e, n);
}
function Oe(e, n) {
  return e != null && $e(e, n, xn);
}
function A(e, n) {
  var r = {};
  return n = C(n), ve(e, function(t, a, o) {
    Qe(r, a, n(t, a, o));
  }), r;
}
function y(e) {
  return e && e.length ? be(e, ye, mn) : void 0;
}
function U(e, n) {
  return e && e.length ? be(e, C(n), ze) : void 0;
}
function En(e, n, r, t) {
  if (!ee(e))
    return e;
  ...
  for (var a = -1, o = n.length, i = o - 1, u = e; u != null && ++a < o; ) {
    ...
    if (a != i) {
      var c = u[d];
      s = void 0, s === void 0 && (s = ee(c) ? c : en(n[a + 1]) ? [] : {});
    }
    xe(u, d, s), u = u[d];
  }
  return e;
...
function Nn(e, n) {
  if (e !== n) {
    var r = e !== void 0, t = e === null, a = e === e, o = ne(e), i = n !== void 0, u = n === null, d = n === n, s = ne(n);
    if (!u && !s && !o && e > n || o && i && d && !u && !s || t && i && d || !r && d || !a)
      return 1;
    if (!t && !o && !s && e < n || s && r && a && !t && !o || u && r && a || !i && a || !d)
      return -1;
  }
  return 0;
}
...
function Pn(e, n, r) {
  n.length ? n = V(n, function(o) {
    return Ee(o) ? function(i) {
      return we(i, o.length === 1 ? o[0] : o);
    } : o;
  }) : n = [ye];
  var t = -1;
  n = V(n, nn(C));
  var a = Xe(e, function(o, i, u) {
    var d = V(n, function(s) {
      return s(o);
    });
    return { criteria: d, index: ++t, value: o };
  });
  return On(a, function(o, i) {
    return Ln(o, i, r);
  });
}
function _n(e, n) {
  return kn(e, n, function(r, t) {
    return qe(e, t);
  });
}
var S = un(function(e, n) {
  return e == null ? {} : _n(e, n);
}), Cn = Math.ceil, Rn = Math.max;
function In(e, n, r, t) {
  for (var a = -1, o = Rn(Cn((n - e) / (r || 1)), 0), i = Array(o); o--; )
    i[++a] = e, e += r;
  return i;
}
function Tn(e) {
  return function(n, r, t) {
    return t && typeof t != "number" && M(n, r, t) && (r = t = void 0), n = T(n), r === void 0 ? (r = n, n = 0) : r = T(r), t = t === void 0 ? n < r ? 1 : -1 : T(t), In(n, r, t);
  };
}
var k = Tn(), I = me(function(e, n) {
  if (e == null)
    return [];
  var r = n.length;
  return r > 1 && M(e, n[0], n[1]) ? n = [] : r > 2 && M(n[0], n[1], n[2]) && (n = [n[0]]), Pn(e, We(n), []);
});
function Mn(e, n, r) {
...
class Sn {
  ...
  toString() {
    for (var n = [], r = this._sentinel, t = r._prev; t !== r; )
      n.push(JSON.stringify(t, jn)), t = t._prev;
    return "[" + n.join(", ") + "]";
  }
}
function te(e) {
...
function Bn(e, n) {
  if (e.nodeCount() <= 1)
    return [];
  var r = Gn(e, n || An), t = Vn(r.graph, r.buckets, r.zeroIdx);
  return O(
    w(t, function(a) {
...
function G(e, n, r, t, a) {
  ...
  return f(e.inEdges(t.v), function(i) {
    ...
    a && o.push({ v: i.v, w: i.w }), d.out -= u, z(n, r, d);
...
function Yn(e) {
  var n = e.graph().acyclicer === "greedy" ? Bn(e, r(e)) : $n(e);
  f(n, function(t) {
    var a = e.edge(t);
...
function ae(e, n) {
  var r = e.x, t = e.y, a = n.x - r, o = n.y - t, i = e.width / 2, u = e.height / 2;
  if (!a && !o)
    throw new Error("Not possible to find intersection inside of the rectangle");
  var d, s;
  return Math.abs(o) * i > Math.abs(a) * u ? (o < 0 && (u = -u), d = u * a / o, s = u) : (a < 0 && (i = -i), d = i, s = i * o / a), { x: r + d, y: t + s };
}
function B(e) {
  ...
  function n(r) {
    ...
    if (t.length && f(t, n), Object.prototype.hasOwnProperty.call(a, "minRank")) {
      ...
      for (var o = a.minRank, i = a.maxRank + 1; o < i; ++o)
        oe(e, "borderLeft", "_bl", r, a, o), oe(e, "borderRight", "_br", r, a, o);
    }
  }
  f(e.children(), n);
}
function oe(e, n, r, t, a, o) {
  var i = { width: 0, height: 0, rank: o, borderType: n }, u = a[n][o - 1], d = N(e, "border", i, r);
  a[n][o] = d, e.setParent(d, t), u && e.setEdge(u, d, { weight: 1 });
}
function Zn(e) {
...
function Jn(e) {
  var n = e.graph().rankdir.toLowerCase();
  (n === "bt" || n === "rl") && Kn(e), (n === "lr" || n === "rl") && (Qn(e), Pe(e));
}
function Pe(e) {
...
function Qn(e) {
  f(e.nodes(), function(n) {
    ...
    var r = e.edge(n);
    f(r.points, $), Object.prototype.hasOwnProperty.call(r, "x") && $(r);
  });
}
function $(e) {
  var n = e.x;
...
function nr(e, n) {
  var r = n.v, t = e.node(r).rank, a = n.w, o = e.node(a).rank, i = n.name, u = e.edge(n), d = u.labelRank;
  if (o !== t + 1) {
    e.removeEdge(n);
    var s = void 0, c, l;
    for (l = 0, ++t; t < o; ++l, ++t)
      u.points = [], s = {
        ...
        edgeObj: n,
        rank: t
      }, c = N(e, "edge", s, "_d"), t === d && (s.width = u.width, s.height = u.height, s.dummy = "edge-label", s.labelpos = u.labelpos), e.setEdge(r, c, { weight: u.weight }, i), l === 0 && e.graph().dummyChains.push(c), r = c;
...
function _e(e) {
  ...
  n.setNode(r, {});
  for (var a, o; tr(n, e) < t; )
    a = ar(n, e), o = n.hasNode(a.v) ? _(e, a) : -_(e, a), ir(n, e, o);
  return n;
}
function tr(e, n) {
  function r(t) {
    f(n.nodeEdges(t), function(a) {
      ...
      !e.hasNode(i) && !_(n, a) && (e.setNode(i, {}), e.setEdge(t, i, {}), r(i));
    });
  }
...
function sr(e, n, r) {
  ...
  e.edge(r, a).cutvalue = Ie(e, n, r);
}
function Ie(e, n, r) {
  var t = e.node(r), a = t.parent, o = !0, i = n.edge(r, a), u = 0;
  return i || (o = !1, i = n.edge(a, r)), u = i.weight, f(n.nodeEdges(r), function(d) {
...
function Fe(e, n, r) {
  ...
  var o = e.node(t), i = e.node(a), u = o, d = !1;
  o.lim > i.lim && (u = i, d = !0);
...
function Se(e, n, r, t) {
  var a = r.v, o = r.w;
  e.removeEdge(a, o), e.setEdge(t.v, t.w, {}), K(e), J(e, n), fr(e, n);
}
function fr(e, n) {
  var r = H(e.nodes(), function(a) {
    return !n.node(a).parent;
  }), t = dr(e, r);
  t = t.slice(1), f(t, function(a) {
    var o = e.node(a).parent, i = n.edge(a, o), u = !1;
...
function pr(e) {
  var n = N(e, "root", {}, "_root"), r = wr(e), t = y(E(r)) - 1, a = 2 * t + 1;
...
function je(e, n, r, t, a, o, i) {
  var u = e.children(i);
  if (!u.length) {
    i !== n && e.setEdge(n, i, { weight: 0, minlen: r });
    return;
  }
  var d = ie(e, "_bt"), s = ie(e, "_bb"), c = e.node(i);
  e.setParent(d, i), c.borderTop = d, e.setParent(s, i), c.borderBottom = s, f(u, function(l) {
    je(e, n, r, t, a, o, l);
    var h = e.node(l), v = h.borderTop ? h.borderTop : l, p = h.borderBottom ? h.borderBottom : l, b = h.borderTop ? t : 2 * t, L = v !== p ? 1 : a - o[i] + 1;
    e.setEdge(d, v, {
      weight: b,
      minlen: L,
      nestingEdge: !0
  ...
  }), e.parent(i) || e.setEdge(n, d, { weight: 0, minlen: a + o[i] });
}
function wr(e) {
  var n = {};
  function r(t, a) {
...
function gr(e, n, r) {
  var t = {}, a;
  f(r, function(o) {
    for (var i = e.parent(o), u, d; i; ) {
      if (u = e.parent(i), u ? (d = t[u], t[u] = i) : (d = a, a = i), d && d !== i) {
        n.setEdge(d, i);
        return;
      }
      i = u;
...
function yr(e, n, r) {
  var t = xr(e), a = new g({ compound: !0 }).setGraph({ root: t }).setDefaultNodeLabel(function(o) {
    return e.node(o);
  });
  return f(e.nodes(), function(o) {
    var i = e.node(o), u = e.parent(o);
    (i.rank === n || i.minRank <= n && n <= i.maxRank) && (a.setNode(o), a.setParent(o, u || t), f(e[r](o), function(d) {
      var s = d.v === o ? d.w : d.v, c = a.edge(s, o), l = m(c) ? 0 : c.weight;
      a.setEdge(s, o, { weight: e.edge(d).weight + l });
...
function Or(e) {
  ...
  function o(u) {
    if (!Oe(n, u)) {
      n[u] = !0;
      var d = e.node(u);
      a[d.rank].push(u), f(e.successors(u), o);
    }
  }
  var i = I(r, function(u) {
    return e.node(u).rank;
  });
  return f(i, o), a;
}
...
function Pr(e) {
  ...
  function r(o) {
    return function(i) {
      i.merged || (m(i.barycenter) || m(o.barycenter) || i.barycenter >= o.barycenter) && _r(o, i);
    };
  }
  function t(o) {
    return function(i) {
...
function Cr(e, n) {
  var r = Xn(e, function(c) {
    return Object.prototype.hasOwnProperty.call(c, "barycenter");
  }), t = r.lhs, a = I(r.rhs, function(c) {
    return -c.i;
  }), o = [], i = 0, u = 0, d = 0;
  t.sort(Rr(!!n)), d = fe(o, a, d), f(t, function(c) {
    d += c.vs.length, o.push(c.vs), i += c.barycenter * c.weight, u += c.weight, d = fe(o, a, d);
  });
  var s = { vs: O(o) };
...
function Ae(e, n, r, t) {
  var a = e.children(n), o = e.node(n), i = o ? o.borderLeft : void 0, u = o ? o.borderRight : void 0, d = {};
  i && (a = R(a, function(p) {
    return p !== i && p !== u;
  }));
  var s = Nr(e, a);
  f(s, function(p) {
    if (e.children(p.v).length) {
      var b = Ae(e, p.v, r, t);
      d[p.v] = b, Object.prototype.hasOwnProperty.call(b, "barycenter") && Tr(p, b);
    }
  });
  var c = Lr(s, r);
  Ir(c, d);
  var l = Cr(c, t);
  if (i && (l.vs = O([i, l.vs, u]), e.predecessors(i).length)) {
    var h = e.node(e.predecessors(i)[0]), v = e.node(e.predecessors(u)[0]);
...
function Mr(e) {
  var n = Le(e), r = ce(e, k(1, n + 1), "inEdges"), t = ce(e, k(n - 1, -1, -1), "outEdges"), a = Or(e);
  le(e, a);
  for (var o = Number.POSITIVE_INFINITY, i, u = 0, d = 0; d < 4; ++u, ++d) {
    Fr(u % 2 ? r : t, u % 4 >= 2), a = B(e);
    var s = Er(e, a);
    s < o && (d = 0, i = fn(a), o = s);
  }
  le(e, i);
...
function Fr(e, n) {
  var r = new g();
  f(e, function(t) {
    var a = t.graph().root, o = Ae(t, a, r, n);
    f(o.vs, function(i, u) {
      t.node(i).order = u;
    }), gr(t, r, o.vs);
  });
...
function Sr(e) {
  ...
  f(e.graph().dummyChains, function(r) {
    for (var t = e.node(r), a = t.edgeObj, o = jr(e, n, a.v, a.w), i = o.path, u = o.lca, d = 0, s = i[d], c = !0; r !== a.w; ) {
      if (t = e.node(r), c) {
        for (; (s = i[d]) !== u && e.node(s).maxRank < t.rank; )
          d++;
        s === u && (c = !1);
      }
      if (!c) {
        for (; d < i.length - 1 && e.node(s = i[d + 1]).minRank <= t.rank; )
          d++;
        s = i[d];
      }
...
function jr(e, n, r, t) {
  var a = [], o = [], i = Math.min(n[r].low, n[t].low), u = Math.max(n[r].lim, n[t].lim), d, s;
  d = r;
  do
    ...
    return f(o, function(c, l) {
      ...
      (h || c === s) && (f(o.slice(u, l + 1), function(p) {
        f(e.predecessors(p), function(b) {
          ...
          (Q < i || v < Q) && !(L.dummy && e.node(p).dummy) && Be(r, b, p);
        });
      }), u = l + 1, i = v);
    }), o;
  }
  ...
  function a(o, i) {
    ...
    return f(i, function(c, l) {
      if (e.node(c).dummy === "border") {
        ...
        h.length && (d = e.node(h[0]).order, t(i, s, l, u, d), s = l, u = d);
      }
      t(i, s, i.length, d, o.length);
    }), i;
  }
  return j(n, a), r;
}
function Gr(e, n) {
  if (e.node(n).dummy)
    return H(e.predecessors(n), function(r) {
    ...
    f(u, function(s) {
      ...
      if (c.length) {
        ...
        for (var l = (c.length - 1) / 2, h = Math.floor(l), v = Math.ceil(l); h <= v; ++h) {
          var p = c[h];
          o[s] === s && d < i[p] && !Yr(r, s, p) && (o[p] = s, o[s] = a[s] = a[p], d = i[p]);
        }
      }
    });
  }), { root: a, align: o };
}
function Dr(e, n, r, t, a) {
  var o = {}, i = qr(e, n, r, a), u = a ? "borderLeft" : "borderRight";
  function d(l, h) {
  ...
  return d(s, i.predecessors.bind(i)), d(c, i.successors.bind(i)), f(t, function(l) {
    o[l] = o[r[l]];
  }), o;
}
function qr(e, n, r, t) {
  var a = new g(), o = e.graph(), i = Ur(o.nodesep, o.edgesep, t);
  return f(n, function(u) {
    var d;
    f(u, function(s) {
      var c = r[s];
      if (a.setNode(c), d) {
        ...
        a.setEdge(l, c, Math.max(i(e, s, d), h || 0));
      }
      d = s;
    });
  }), a;
...
function zr(e, n) {
  var r = E(n), t = P(r), a = y(r);
  f(["u", "d"], function(o) {
    f(["l", "r"], function(i) {
      var u = o + i, d = e[u], s;
      if (d !== n) {
        var c = E(d);
        s = i === "l" ? t - P(c) : a - y(c), s && (e[u] = A(d, function(l) {
          return l + s;
        }));
      }
    });
...
function Hr(e) {
  var n = B(e), r = W(Br(e, n), Vr(e, n)), t = {}, a;
  f(["u", "d"], function(i) {
    a = i === "u" ? n : E(n).reverse(), f(["l", "r"], function(u) {
      u === "r" && (a = w(a, function(l) {
        return E(l).reverse();
      }));
      var d = (i === "u" ? e.predecessors : e.successors).bind(e), s = $r(e, a, r, d), c = Dr(e, a, s.root, s.align, u === "r");
      u === "r" && (c = A(c, function(l) {
        return -l;
      })), t[i + u] = c;
    });
  });
  var o = Wr(e, t);
  return zr(t, o), Xr(t, e.graph().align);
}
function Ur(e, n, r) {
  return function(t, a, o) {
    var i = t.node(a), u = t.node(o), d = 0, s;
    if (d += i.width / 2, Object.prototype.hasOwnProperty.call(i, "labelpos"))
    ...
    if (s && (d += r ? s : -s), s = 0, d += (i.dummy ? n : e) / 2, d += (u.dummy ? n : e) / 2, d += u.width / 2, Object.prototype.hasOwnProperty.call(u, "labelpos"))
...
function Jr(e) {
  e = Ne(e), Kr(e), bn(Hr(e), function(n, r) {
    e.node(r).x = n;
  });
}
function Kr(e) {
...
function Pt(e, n) {
  var r = Hn;
  r("layout", () => {
    var t = r("  buildLayoutGraph", () => st(e));
    r("  runLayout", () => Qr(t, r)), r("  updateInputGraph", () => et(e, t));
  });
}
function Qr(e, n) {
  n("    makeSpaceForEdgeLabels", () => ft(e)), n("    removeSelfEdges", () => gt(e)), n("    acyclic", () => Yn(e)), n("    nestingGraph.run", () => pr(e)), n("    rank", () => lr(Ne(e))), n("    injectEdgeLabelProxies", () => ct(e)), n("    removeEmptyRanks", () => zn(e)), n("    nestingGraph.cleanup", () => mr(e)), n("    normalizeRanks", () => Wn(e)), n("    assignRankMinMax", () => lt(e)), n("    removeEdgeLabelProxies", () => ht(e)), n("    normalize.run", () => er(e)), n("    parentDummyChains", () => Sr(e)), n("    addBorderSegments", () => Un(e)), n("    order", () => Mr(e)), n("    insertSelfEdges", () => yt(e)), n("    adjustCoordinateSystem", () => Zn(e)), n("    position", () => Jr(e)), n("    positionSelfEdges", () => xt(e)), n("    removeBorderNodes", () => mt(e)), n("    normalize.undo", () => rr(e)), n("    fixupEdgeLabelCoords", () => wt(e)), n("    undoCoordinateSystem", () => Jn(e)), n("    translateGraph", () => vt(e)), n("    assignNodeIntersects", () => pt(e)), n("    reversePoints", () => bt(e)), n("    acyclic.undo", () => Dn(e));
}
function et(e, n) {
  f(e.nodes(), function(r) {
...
var nt = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], rt = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" }, tt = ["acyclicer", "ranker", "rankdir", "align"], at = ["width", "height"], it = { width: 0, height: 0 }, ot = ["minlen", "weight", "width", "height", "labeloffset"], ut = {
  minlen: 1,
  weight: 1,
  width: 0,
  height: 0,
...
function st(e) {
  ...
  return n.setGraph(
    ...
    var a = q(e.node(t));
    n.setNode(t, ln(D(a, at), it)), n.setParent(t, e.parent(t));
...
function vt(e) {
  var n = Number.POSITIVE_INFINITY, r = 0, t = Number.POSITIVE_INFINITY, a = 0, o = e.graph(), i = o.marginx || 0, u = o.marginy || 0;
  function d(s) {
  ...
  }), o.width = r - n + i, o.height = a - t + u;
}
function pt(e) {
  f(e.edges(), function(n) {
    var r = e.edge(n), t = e.node(n.v), a = e.node(n.w), o, i;
    r.points ? (o = r.points[0], i = r.points[r.points.length - 1]) : (r.points = [], o = a, i = t), r.points.unshift(ae(t, o)), r.points.push(ae(a, i));
  });
}
function wt(e) {
  f(e.edges(), function(n) {
...
function mt(e) {
  f(e.nodes(), function(n) {
    if (e.children(n).length) {
      var r = e.node(n), t = e.node(r.borderTop), a = e.node(r.borderBottom), o = e.node(F(r.borderLeft)), i = e.node(F(r.borderRight));
...
function yt(e) {
  ...
  f(n, function(r) {
    ...
    f(r, function(a, o) {
      var i = e.node(a);
      i.order = o + t, f(i.selfEdges, function(u) {
        N(
          e,
          "selfedge",
          {
...
function xt(e) {
  f(e.nodes(), function(n) {
    var r = e.node(n);
    if (r.dummy === "selfedge") {
      var t = e.node(r.e.v), a = t.x + t.width / 2, o = t.y, i = r.x - a, u = t.height / 2;
