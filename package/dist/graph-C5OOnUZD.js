import { ar as T, as as C, at as X, au as R, av as k, aw as L, ax as V, ay as j, az as ee, aA as te, aB as re, aC as se, aD as ne, aE as ie, aF as ae, aG as oe, aH as y, aI as P, aJ as S } from "./mermaid.core-D3xORQza.js";
import { k as d, g as K, s as ue, d as he, e as de, f as ce, h as fe, i as ge, b as le, j as m, l as g, r as _e } from "./_baseUniq-DgROQpJ4.js";
import { Y as $, Z as Y, _ as be, x as pe, v as ye } from "./main-Cl7J0_dP.js";
function me(t, e) {
  return t && T(e, d(e), t);
}
function je(t, e) {
...
var I = $ ? $.prototype : void 0, D = I ? I.valueOf : void 0;
function Pe(t) {
  return D ? Object(D.call(t)) : {};
}
var Se = "[object Boolean]", $e = "[object Date]", Ie = "[object Map]", De = "[object Number]", Me = "[object RegExp]", xe = "[object Set]", Ge = "[object String]", Ue = "[object Symbol]", Be = "[object ArrayBuffer]", Re = "[object DataView]", Ve = "[object Float32Array]", Ke = "[object Float64Array]", Ye = "[object Int8Array]", He = "[object Int16Array]", qe = "[object Int32Array]", Je = "[object Uint8Array]", We = "[object Uint8ClampedArray]", Ze = "[object Uint16Array]", ze = "[object Uint32Array]";
function Qe(t, e, r) {
  var s = t.constructor;
  switch (e) {
    case Be:
...
function O(t, e, r, s, n, a) {
  ...
  var Q = z ? h ? Ee : ce : h ? C : d, v = w ? void 0 : Q(t);
  return fe(v || t, function(c, f) {
    v && (f = c, c = t[f]), ie(i, f, O(c, e, r, f, t, a));
  }), i;
}
function vt(t, e) {
...
function A(t) {
  return t == null ? [] : vt(t, d(t));
}
function b(t) {
  return t === void 0;
}
var Pt = ae(function(t) {
  return ge(le(t, 1, oe, !0));
}), St = "\0", l = "\0", G = "";
class Z {
  constructor(e = {}) {
  ...
  setDefaultNodeLabel(e) {
    return P(e) || (e = y(e)), this._defaultNodeLabelFn = e, this;
  }
  nodeCount() {
  ...
  setDefaultEdgeLabel(e) {
    return P(e) || (e = y(e)), this._defaultEdgeLabelFn = e, this;
  }
  edgeCount() {
