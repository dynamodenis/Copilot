import { m as ot, f as pp, d as mp } from "./min-CwHvXh0A.js";
import { b as gp, i as yp, c as Tp, j as vp, r as Il, l as ta } from "./_baseUniq-CMb9V5eS.js";
import { aJ as $p } from "./mermaid.core-GX_tk5Uy.js";
function Rp(t, e) {
  return gp(ot(t, e));
}
function Ap(t, e) {
...
var it = {}, Fk = {
  info: /* @__PURE__ */ A(async () => {
    const { createInfoServices: t } = await import("./info-NVLQJR56-D7wuOUSq.js"), e = t().Info.parser.LangiumParser;
    it.info = e;
  }, "info"),
  packet: /* @__PURE__ */ A(async () => {
    const { createPacketServices: t } = await import("./packet-BFZMPI3H-G9PEY_Jm.js"), e = t().Packet.parser.LangiumParser;
    it.packet = e;
  }, "packet"),
  pie: /* @__PURE__ */ A(async () => {
    const { createPieServices: t } = await import("./pie-7BOR55EZ-DZ9e_Ax3.js"), e = t().Pie.parser.LangiumParser;
    it.pie = e;
  }, "pie"),
  architecture: /* @__PURE__ */ A(async () => {
    const { createArchitectureServices: t } = await import("./architecture-U656AL7Q-K5NVZIDl.js"), e = t().Architecture.parser.LangiumParser;
    it.architecture = e;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ A(async () => {
    const { createGitGraphServices: t } = await import("./gitGraph-F6HP7TQM-DL_pepSN.js"), e = t().GitGraph.parser.LangiumParser;
    it.gitGraph = e;
  }, "gitGraph"),
  radar: /* @__PURE__ */ A(async () => {
    const { createRadarServices: t } = await import("./radar-NHE76QYJ-D0hm2rW_.js"), e = t().Radar.parser.LangiumParser;
    it.radar = e;
  }, "radar"),
  treemap: /* @__PURE__ */ A(async () => {
    const { createTreemapServices: t } = await import("./treemap-KMMF4GRG-BNRbiuBc.js"), e = t().Treemap.parser.LangiumParser;
    it.treemap = e;
  }, "treemap")
};
